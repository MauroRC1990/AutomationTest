...
public class NewTerminationReasonTest {
	...
	public void newTerminationReason() {
		...
		orangeHRMPage.setTerminationName("KIA");
		orangeHRMPage.save();
		...
		try {
			FileUtils.copyFile(file, new File("C:\\Users\\Solidus\\Documents\\Mis trabajos\\Trabajo QA\\Test Screenshots\\NewTerminationReasonScreenshot.png"));
		} catch (IOException e) {
