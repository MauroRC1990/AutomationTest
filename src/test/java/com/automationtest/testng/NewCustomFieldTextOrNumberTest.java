...
public class NewCustomFieldTextOrNumberTest {
	...
	@Test
	public void newCustomFieldTextOrNumber() {
		OrangeHRMPage orangeHRMPage = new OrangeHRMPage(driver, wait);
		...
		try {
			FileUtils.copyFile(file, new File("C:\\Users\\Solidus\\Documents\\Mis trabajos\\Trabajo QA\\Test Screenshots\\NewCustomFieldTextOrNumberScreenshot.png"));
		} catch (IOException e) {
