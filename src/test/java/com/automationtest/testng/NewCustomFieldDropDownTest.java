...
public class NewCustomFieldDropDownTest {
	...
	public void newCustomFieldDropDown() {
		...
		orangeHRMPage.setOptionsField("Soldier,Infiltrator,Sentinel,Adept,Engineer,Vanguard");
		orangeHRMPage.save();
		...
		try {
			FileUtils.copyFile(file, new File("C:\\Users\\Solidus\\Documents\\Mis trabajos\\Trabajo QA\\Test Screenshots\\NewCustomFieldDropDownScreenshot.png"));
		} catch (IOException e) {
