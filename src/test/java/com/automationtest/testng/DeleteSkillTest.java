...
public class DeleteSkillTest {
	...
	public void deleteSkill() {
		...
		orangeHRMPage.selectDeleteN7Skill();
		...
		try {
			FileUtils.copyFile(file, new File("C:\\Users\\Solidus\\Documents\\Mis trabajos\\Trabajo QA\\Test Screenshots\\DeleteSkillScreenshot.png"));
		} catch (IOException e) {
